...
"")
        ...
        self.tno_lineEdit_2 = QtWidgets.QLineEdit(self.tab)
        self.tno_lineEdit_2.setGeometry(QtCore.QRect(120, 100, 221, 41))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        ...
        font.setWeight(50)
        font.setStrikeOut(False)
        self.tno_lineEdit_2.setFont(font)
        self.tno_lineEdit_2.setStyleSheet("border:2px solid rgb(186,186,186);\n"
"font: 10pt \"微软雅黑\";\n"
"border-radius:10px\n"
"")
        self.tno_lineEdit_2.setText("")
        self.tno_lineEdit_2.setObjectName("tno_lineEdit_2")
...
"")
    ...
    def retranslateUi(self, MainWindow_signup):
        ...
        self.tno_lineEdit_2.setPlaceholderText(_translate("MainWindow_signup", "工号"))
